          ...
          <div class="md:col-span-8 space-y-6">
            <div>
              ...
              <p class="text-zinc-300 text-sm leading-relaxed">
                ${currentLang === 'vi' ? 
                  'Đây là CV của Nguyễn Thanh Hiền, một Web Developer và là sinh viên Công nghệ Thông tin năm cuối tại trường Cao đẳng Công nghệ Thủ Đức. Xuyên suốt hồ sơ, tôi thể hiện rõ định hướng xây dựng các ứng dụng web Full-stack dựa trên nền tảng kỹ thuật vững chắc với HTML, CSS, JavaScript cho Front-end và Laravel, MySQL cho Back-end. Điểm nhấn ấn tượng nhất trong CV là kinh nghiệm thực chiến mạnh mẽ thông qua 3 dự án cốt lõi: hệ thống E-commerce (nơi tôi đảm nhận vai trò Trưởng nhóm và Lập trình viên Back-end), website Điện Máy PRO (nơi tôi kiêm nhiệm cả vai trò Developer và QA/QC), cùng trang Portfolio cá nhân do tôi tự thiết kế và triển khai lên môi trường thực tế. Bên cạnh năng lực chuyên môn, CV còn làm nổi bật sự nhạy bén công nghệ thông qua khả năng ứng dụng AI vào lập trình, kỹ năng quản lý phiên bản với Git/GitHub, cũng như các kỹ năng mềm quan trọng như làm việc nhóm, quản lý thời gian và giao tiếp. Tóm lại, CV này khắc họa chân dung của một lập trình viên trẻ đầy tham vọng, có tư duy hệ thống toàn diện từ khâu lên kế hoạch, lập trình đến kiểm thử chất lượng, luôn sẵn sàng cống hiến kỹ năng giải quyết vấn đề cho một đội ngũ phát triển chuyên nghiệp.' : 
                  'This is the CV of Nguyen Thanh Hien, a Web Developer and final-year Information Technology student at Thu Duc College of Technology. Throughout the profile, Hien clearly demonstrates a strong orientation towards building Full-stack web applications based on a solid technical foundation of HTML, CSS, and JavaScript for Front-end, and Laravel and MySQL for Back-end. The most impressive highlight in this CV is the strong hands-on experience gained through 3 core projects: an E-commerce system (where Hien served as Team Leader and Back-end Developer), the Dien May PRO website (where Hien worked as both Developer and QA/QC), and a personal Portfolio website that Hien designed and deployed in a production environment. In addition to technical competence, this CV highlights technological agility through the ability to apply AI to programming, version control skills with Git/GitHub, as well as crucial soft skills such as teamwork, time management, and communication. In summary, this CV portrays an ambitious young developer with a comprehensive systems mindset from planning and programming to quality testing, always ready to contribute problem-solving skills to a professional development team.'}
              </p>
            </div>
            ...
            <div class="pt-4 flex flex-wrap gap-4">
              <a href="./CV/24211TT3646_NGUYENTHANHHIEN_CV.pdf" target="_blank" class="px-6 py-2.5 rounded-full bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 text-white font-bold transition-all duration-300 flex items-center gap-2 shadow-lg">
                <i class="fa-solid fa-file-pdf"></i> ${currentLang === 'vi' ? 'XEM CV PDF' : 'VIEW CV PDF'}
              </a>
            </div>
          </div>
        </div>
